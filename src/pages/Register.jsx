...
import  LockClockOutlinedIcon  from '@mui/icons-material/LockOutlined';
        ...
        <Box sx={{ mt: 8, display: "flex",flexDirection: "column",alignItems: "center"}}>
            ...
            <Box component={"form"} sx={{mt: 3}} onSubmit={registerUser}>
               <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <TextField autoComplete='email' type='password' fullWidth required name="email" id='email' label="Email"></TextField>
                  </Grid>
                  <Grid item xs={12}>
                    <TextField autoComplete='new-password' fullWidth required name="password" id='password' label="Password"></TextField>
                  </Grid>
               </Grid>
