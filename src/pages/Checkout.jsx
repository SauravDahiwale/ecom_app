...
function Checkout() {
  ...
  sx={{
    ...
    <Paper variant='outlined' sx={{my:{xs:3,md:6},p:{xs:2,md:3}}}>
      ...
      <Typography>
        Your Order number is #1234. We have emailed you regarding your order confirmation
      </Typography>
      ...
      <>
       ...
       <Box sx={{display:'flex', justifyContent:'flex-end'}}>
           ...
           <Button sx={{
            mt:3,
            ml:1,
           }} onClick={handleNext} variant='contained'>{activeStep===steps.length-1? "Place Order" : "Next"}
           </Button>
       </Box>
      </>
      )}
